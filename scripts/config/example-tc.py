...
client_0 = Client()
client_0.add_iface(iface_0, ip="169.254.0.2", gateway="169.254.0.1", delay=100)
tgen_0 = TrafficGenerator("169.254.0.5", pages=["40.html"], congestion_control=CongestionControlType.cubic)
tgen_0.add_iface(iface_0, ip="169.254.0.3", gateway="169.254.0.1", drop_percent=50)
tgen_1 = TrafficGenerator("169.254.0.5", pages=["40.html"], congestion_control=CongestionControlType.reno)
tgen_1.add_iface(iface_0, ip="169.254.0.4", gateway="169.254.0.1", drop_percent=50)
...
client_1 = Client()
client_1.add_iface(iface_1, ip="169.254.1.2", gateway="169.254.1.1", delay=100)
tgen_2 = TrafficGenerator("169.254.1.5", pages=["40.html"], congestion_control=CongestionControlType.cubic)
tgen_2.add_iface(iface_1, ip="169.254.1.3", gateway="169.254.1.1", drop_percent=50)
tgen_3 = TrafficGenerator("169.254.1.5", pages=["40.html"], congestion_control=CongestionControlType.reno)
tgen_3.add_iface(iface_1, ip="169.254.1.4", gateway="169.254.1.1", drop_percent=50)
