...
tgen_0 = TrafficGenerator("server-0.com", pages=["/40.html"])
...
tgen_1 = TrafficGenerator("server-0.com", pages=["/40.html"])
...
tgen_2 = TrafficGenerator("server-0.com", pages=["/40.html"], proto=Protocol.https, conn_max=200)
