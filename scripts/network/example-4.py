...
tgen_0.add_iface(iface_0, "169.254.0.3", "169.254.0.1", drop_percent=50)
tgen_1 = TrafficGenerator("169.254.0.5", pages=["40.html"], congestion_control=CongestionControlType.reno)
tgen_1.add_iface(iface_0, "169.254.0.4", "169.254.0.1", drop_percent=50)
...
tgen_2.add_iface(iface_1, "169.254.1.3", "169.254.1.1", drop_percent=50)
tgen_3 = TrafficGenerator("169.254.1.5", pages=["40.html"], congestion_control=CongestionControlType.reno)
tgen_3.add_iface(iface_1, "169.254.1.4", "169.254.1.1", drop_percent=50)
